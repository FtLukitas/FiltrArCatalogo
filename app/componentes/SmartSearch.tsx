  ...
  return (
    <div ref={searchRef} className="relative w-full max-w-3xl mx-auto z-[999]">
      ...
      <div className="relative">
        ...
        {/* RESULTADOS DESPLEGABLES INSTANTÁNEOS (DIRECTAMENTE DEBAJO DEL INPUT CON Z-[9999]) */}
        {focused && query.trim().length >= 2 && (
          <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden z-[9999] animate-fade-in max-h-[520px] overflow-y-auto">
            {loading ? (
